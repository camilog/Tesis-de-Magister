...
\todo{agregar diagrama sumando varios mensajes $M_i$ y mostrando suma de mensajes 
individuales}
...
$t^{(2k)}, t^{(2k + 1)}$ menores a $t^{(k)}$  \todoline{revisar que si para que suceda esto 
es necesario hablar de $M_i$ en vez de $m_i$}, resultando en que recursivamente en rondas 
