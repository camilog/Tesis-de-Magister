...
\begin{enumerate}
    ...
    \emph{microblogging} anónimo (un símil a \emph{Twitter} anónimo). \todoline{Agregar referencia 
    a las prubeas, sobre tiempos alcanzados en el escenario de 30 personas enviando mensajes de 140 caracteres}.
    ...
    participantes. \todoline{Agregar punch en este tema}
    ...
    de mensajes, manejo de desconexiones de usuarios, sincronización entre los distintos participantes, 
    etc).
    \item Construcción de aplicación final: un paso muy importante en el estudio de protocolos criptográficos 
